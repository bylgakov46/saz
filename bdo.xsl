  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        ...
        <title> Отчёт сканирования </title>
      </head>
      <body>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1>Отчёт сканирования<br/> <img src="https://3d-stl.com/upload/iblock/948/9484c3a270955c4c5a7e4a52acdd1ec1.png"> <small>Программное средство анализа защищенности узлов информационных систем</small></h1>
            <p class="lead">
